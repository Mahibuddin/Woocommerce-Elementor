...
class RRFCommerce_product_Widget extends \Elementor\Widget_Base {


	public function get_name() {
		return 'rrfcommerce-product';
	}


	public function get_title() {
		return __( 'RRFCommerce Product', 'plugin-name' );
	}
	...
	protected function render() {
        ...
        if($settings['carousel'] == true){echo '</div>';}
